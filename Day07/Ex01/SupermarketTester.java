public class SupermarketTester {
  ...
  private void run() {
    ...
    System.out.println("The max size for this queue is: " + mySupermarket.getMaxSize());
    ...
    System.out.println("The current size of the queue is: " + mySupermarket.getSize());
    mySupermarket.printQueue();
    mySupermarket.retrieve();
    mySupermarket.retrieve();
    mySupermarket.retrieve();
    System.out.println("Now, the size of the queue is: " + mySupermarket.getSize());
