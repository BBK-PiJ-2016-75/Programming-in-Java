//Program to plot the coordinates of three points, and then see which two are closest.
...
double dist1_2 = Math.sqrt((Math.pow(firstPoint.x - secondPoint.x, 2))+(Math.pow(firstPoint.y - secondPoint.y, 2)));
double dist1_3 = Math.sqrt((Math.pow(firstPoint.x - thirdPoint.x, 2))+(Math.pow(firstPoint.y - thirdPoint.y, 2)));
double dist2_3 = Math.sqrt((Math.pow(secondPoint.x - thirdPoint.x, 2))+(Math.pow(secondPoint.y - thirdPoint.y, 2)));

//Compare the distances.

if ((dist1_2 < dist1_3) && (dist1_2 < dist2_3)) {
  println("The first and second points are closest, as " + dist1_2 + " is a shorter distance than " + dist1_3 + " and " + dist2_3 + ".");
} else if ((dist1_3 < dist1_2) && (dist1_3 < dist2_3)) {
  println("The first and third points are closest, as " + dist1_3 + " is a shorter distance than " + dist1_2 + " and " + dist2_3 + ".");
} else {
  println("The second and third points are closest, as " + dist2_3 + " is a shorter distance than " + dist1_2 + " and " + dist1_3 + ".");
}